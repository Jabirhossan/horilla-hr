...
which lists bonus point setting, question template and period as tabs
"""
...
from pms.models import BonusPointSetting, Period, QuestionTemplate


@method_decorator(login_required, name="dispatch")
class PerformanceSettingsView(TemplateView):
    """
    page for performance settings (Bonus Point Setting, Question Template
    and Period tabs)
    """
