...
def payroll_calculation(employee, start_date, end_date, month_summary=None):
    ...
    payslip_data = {
        ...
        "present": basic_pay_details.get("present", 0),
        "paid_leave": basic_pay_details.get("paid_leave", 0),
        "unpaid_leave": basic_pay_details.get("unpaid_leave", 0),
        "absent": basic_pay_details.get("absent", 0),
        "week_off": basic_pay_details.get("week_off", 0),
        "holiday": basic_pay_details.get("holiday", 0),
        "total_working": basic_pay_details.get("total_working", 0),
        "calendar_days": basic_pay_details.get("calendar_days", 0),
        "per_day_amount": basic_pay_details.get("per_day_amount", 0),
